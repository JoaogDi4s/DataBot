...
public class CargoCRUD implements CRUD {
        ...
        if (cargoBuscado != null) {
            ...
            while (continuarCargo) {
                ...
                for (String op : escolhas) {
                    System.out.println(msg.separadorEmcima()); // ADICIONAR EM TODOS OS
                    ...
                    System.out.println(msg.separadorEmbaixo()); // Fechamento do bloco de
                                                                // informações
                }
    ...
    public void atualizar() {
        ...
        if (cargoBucasdo != null) {
            ...
            System.out.println(msg.cargoNaoEncontrado() + "Deseja tentar novamente? sim/nao");
        ...
        while (!cargoEncontrado) {
            ...
            if (cargoBuscado != null) {
                ...
                if (confirmacao.equals("sim")) {
                    ...
                    System.out.println("Cargo" + msg.campoDeletado());
                ...
                System.out.println(
                        msg.cargoNaoEncontrado() + "Deseja tentar novamente? (sim/nao)");
                String tentarNovamente = InputUtils.getInput(scan).toLowerCase();
                if (!tentarNovamente.equals("sim")) {
                    System.out.println(msg.operacaoEncerrada());
                    break; // Sai do loop
